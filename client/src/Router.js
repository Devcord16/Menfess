...
const createSearchLoader =
  ...
  ({ request }) => {
    ...
    return axios.get(
      `${process.env.REACT_APP_API_BASE_URL}/${type}/posts?search=${query}`
    );
  };
...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route element={<App />} errorElement={<ErrorBoundary />}>
      ...
      <Route
        path="search"
        loader={createSearchLoader("main")}
        element={<Posts type="main" />}
      />
      <Route
        path="post/:id"
        shouldRevalidate={shouldRevalidate}
        loader={createPostLoader("main")}
        element={<Post type="main" />}
      />
      <Route path="memes">
        <Route
          index
          shouldRevalidate={shouldRevalidate}
          loader={createPostsLoader("memes")}
          element={<Posts type="memes" />}
        />
        <Route
          path="search"
          loader={createSearchLoader("memes")}
          element={<Posts type="memes" />}
        />
        <Route
          path="post/:id"
          shouldRevalidate={shouldRevalidate}
          loader={createPostLoader("memes")}
          element={<Post type="memes" />}
        />
      </Route>
      <Route path="anime">
        <Route
          index
          shouldRevalidate={shouldRevalidate}
          loader={createPostsLoader("anime")}
          element={<Posts type="anime" />}
        />
        <Route
          path="search"
          loader={createSearchLoader("anime")}
          element={<Posts type="anime" />}
        />
        <Route
          path="post/:id"
          shouldRevalidate={shouldRevalidate}
          loader={createPostLoader("anime")}
          element={<Post type="anime" />}
        />
      </Route>
    </Route>
  )
